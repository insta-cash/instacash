...
This means one can have an always-on instacashd instance running, and another local instacashd/instacash-qt instance which connects to this node and receives blocks from it.
