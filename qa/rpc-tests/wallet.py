...
#   c) node1 mines 32 blocks, so now node 0 has 60001ich, node 1 has 4250ich, node2 has none.
#   d) node0 sends 601 ich to node2, in two transactions (301 ich, then 300 ich).
