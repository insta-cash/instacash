...
In order to support loading of multiple wallets in instacash-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is instacash.cpp.
...
Changes to instacash.cpp
----------------------
instacash.cpp is the entry point into instacash-qt, and as such, will require some minor modifications to provide hooks for
