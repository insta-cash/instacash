Contributing to InstaCash Core
============================

The InstaCash Core project operates an open contributor model where anyone is
...
The following applies to code changes to the InstaCash Core project, and is not to be
confused with overall InstaCash Network Protocol consensus changes.

Whether a pull request is merged into InstaCash Core rests with the project merge
...
Patches that change InstaCash consensus rules are considerably more involved than
...
Where a patch set proposes to change the InstaCash consensus, it must have been
...
The project leader is the release manager for each InstaCash Core release.
