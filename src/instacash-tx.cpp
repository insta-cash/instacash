...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("InstaCash Core instacash-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  instacash-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded instacash transaction") + "\n" +
                               "  instacash-tx [options] -create [commands]   " + _("Create hex-encoded instacash transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded instacash transaction
