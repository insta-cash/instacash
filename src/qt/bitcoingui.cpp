                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("InstaCash Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a InstaCash address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and instacash: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About InstaCash Core"), this);
    aboutAction->setStatusTip(tr("Show information about InstaCash Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for InstaCash"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your InstaCash addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified InstaCash addresses"));
    ...
    openAction->setStatusTip(tr("Open a InstaCash: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the InstaCash Core help message to get a list with possible InstaCash command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("InstaCash Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to InstaCash network", "", count));
}
...
{
    QString strTitle = tr("InstaCash Core"); // default title
