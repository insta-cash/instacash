...
/* InstaCash GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "InstaCash"
#define QAPP_ORG_DOMAIN "instacash.org"
#define QAPP_APP_NAME_DEFAULT "InstaCash-Qt"
#define QAPP_APP_NAME_TESTNET "InstaCash-Qt-testnet"
