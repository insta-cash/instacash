...
/** Utility functions used by the InstaCash Qt UI.
 */
namespace GUIUtil
{
...
// Render InstaCash addresses in monospace font
...
// Parse "instacash:" URI into recipient object, return true on successful parsing
