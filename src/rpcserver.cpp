...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop InstaCash server.");
    // Event loop will exit after current HTTP requests have been handled, so
    // this reply will get back to the client.
    StartShutdown();
    return "InstaCash server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* InstaCash features */
        {"instacash", "masternode", &masternode, true, true, false},
        {"instacash", "listmasternodes", &listmasternodes, true, true, false},
        {"instacash", "getmasternodecount", &getmasternodecount, true, true, false},
        {"instacash", "masternodeconnect", &masternodeconnect, true, true, false},
        {"instacash", "masternodecurrent", &masternodecurrent, true, true, false},
        {"instacash", "masternodedebug", &masternodedebug, true, true, false},
        {"instacash", "startmasternode", &startmasternode, true, true, false},
        {"instacash", "createmasternodekey", &createmasternodekey, true, true, false},
        {"instacash", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"instacash", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"instacash", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"instacash", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"instacash", "getmasternodescores", &getmasternodescores, true, true, false},
        {"instacash", "mnbudget", &mnbudget, true, true, false},
        {"instacash", "preparebudget", &preparebudget, true, true, false},
        {"instacash", "submitbudget", &submitbudget, true, true, false},
        {"instacash", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"instacash", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"instacash", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"instacash", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"instacash", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"instacash", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"instacash", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"instacash", "checkbudgets", &checkbudgets, true, true, false},
        {"instacash", "mnsync", &mnsync, true, true, false},
        {"instacash", "spork", &spork, true, true, false},
        {"instacash", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"instacash", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
{
    return "> instacash-cli " + methodname + " " + args + "\n";
}
