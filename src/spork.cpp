...
// Copyright (c) 2016-2017 The InstaCash developers
...
// InstaCash: on startup load spork values from previous session if they exist in the sporkDB
...
void ProcessSpork(CNode* pfrom, std::string& strCommand, CDataStream& vRecv)
{
    ...
    if (strCommand == "spork") {
        ...
        // InstaCash: add to spork database.
